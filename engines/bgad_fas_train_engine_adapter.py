...
from utils import t2np, get_logp, adjust_learning_rate, warmup_learning_rate, save_results, save_weights_ada, load_weights_ada
...
def train(args):
    ...
    for epoch in range(args.meta_epochs):
        if args.checkpoint:
            load_weights_ada(encoder, decoders, args.checkpoint)
